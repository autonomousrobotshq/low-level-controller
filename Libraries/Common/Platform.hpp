...
/* EXECUTION INTERVALS */
// GPS, IMU, HALL, CURRENT, TEMPERATURE, ULTRASONIC, CONTROLLER_MOTOR, CONTROLLER_AWARENESS, CONTROLLER_ANOMALY, CONTROLLER_LOGGING
const t_exec_intervals exec_intervals = { 1000, 20, 20, 20, 1000, 20, 0, 0, 0, 100 };
