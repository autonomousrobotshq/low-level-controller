#ifndef _ROS_llc_messages_Gps_h
#define _ROS_llc_messages_Gps_h
...
namespace llc_messages
{
  ...
  class Gps : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "llc_messages/Gps"; };
    virtual const char * getMD5() override { return "c24029cbb90b28da08009a1a44081308"; };
