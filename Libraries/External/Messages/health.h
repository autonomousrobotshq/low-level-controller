#ifndef _ROS_llc_messages_health_h
#define _ROS_llc_messages_health_h
...
namespace llc_messages
{
  ...
  class health : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "llc_messages/health"; };
