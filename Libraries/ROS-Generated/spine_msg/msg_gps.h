#ifndef _ROS_spine_msg_msg_gps_h
#define _ROS_spine_msg_msg_gps_h
...
namespace spine_msg
{
  ...
  class msg_gps : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "spine_msg/msg_gps"; };
